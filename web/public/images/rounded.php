...
$shape = isset($shape) ? strval($shape) : (isset($sh) ? strval($sh) : 'r');
$radius = isset($radius) ? intval($radius) : (isset($r) ? intval($r) : 20);
$width = isset($width) ? intval($width) : (isset($w) ? intval($w) : $radius*2);
$height = isset($height) ? intval($height) : (isset($h) ? intval($h) : $radius*2);
$foregroundcolor = isset($foregroundcolor) ? strval($foregroundcolor) : (isset($c) ? strval($c) : 'CCCCCC');
...
$borderwidth = isset($borderwidth) ? intval($borderwidth) : (isset($b) ? intval($b) : 10);
...
$backgroundopacity = isset($backgroundopacity) ? intval($backgroundopacity) : (isset($bgo) ? intval($bgo) : 0);
...
$borderwidth = $borderwidth > 100 ? 100 : $borderwidth;
...
$file = $dir.'rounded_'.$foregroundcolor.'_'.$bordercolor.'_'.$radius.'_'.$borderwidth.'.png';
if (!file_exists($file)) {
