...
if (strtoupper(substr(PHP_OS, 0, 3)) == 'WIN') {
	...
	$PHPTHUMB_CONFIG['imagemagick_path'] = 'C:/Program Files/ImageMagick-6.6.6-Q16/convert.exe';
} else {
...
$PHPTHUMB_CONFIG['error_image_width']           = @$_GET['w'] > 0 ? @$_GET['w'] : 400;      // default width for error images
$PHPTHUMB_CONFIG['error_image_height']          = @$_GET['h'] > 0 ? @$_GET['h'] : 100;      // default height for error images
$PHPTHUMB_CONFIG['error_message_image_default'] = @$_GET['w'] <= 22 ? 'error-small.png' : 'error.png';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
